...
- TBD - A way to track the amount of deep work time accumulated so far so we can celebrate. The inspiration comes from Cal Newport's blog  [here](https://calnewport.com/lab-notes-i-spent-42-hours-last-month-on-the-activity-most-critical-to-my-success/) and [here](https://calnewport.com/from-deep-tallies-to-deep-schedules-a-recent-change-to-my-deep-work-habits/). I'll come back with the solution that worked for me when I review how this routine worked in practice along the way.
...
Generally speaking try to allocate as much deep work time as you can during the day. If you feel this is not detailed enough I encourage you to read the full description in the above-mentioned book _deep work_ p. 223. Or wait until I dedicate a full post to this part of the day.
...
using the template mentioned in [shutdown](#shutdown-the-workday-ritual) I read what was open yesterday and move it to my TODOs section. This way I know what's on my plate for today.
...
- `TODOs` (where I mark as done when completed during the day)
- `Code` for things I worked on
- `Carry on` collecting next days items during the day, knowing I won't complete them today
- `Documents` links to different documents I've written
- `Meetings` I attended
- `PRs` I created or merged
- A `blob` section for how I felt during the day or anything special that happened.
...
# Next steps
Well this one got a bit longer than I expected, and I couldn't even fit everything into it. I plan to try and work like that starting next week. And I'll come back with a report on how it goes, and what I feel I should tune to make it better. What worked, what failed and what changes did I make.
Other than that other posts with thoughts and implementations of them are on their way.